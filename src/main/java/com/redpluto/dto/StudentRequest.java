...
public class StudentRequest {
	...
	return "StudentRequest [studentName=" + studentName + ", age=" + age + ", englishMarks=" + englishMarks
		+ ", scienceMarks=" + scienceMarks + ", mathMarks=" + mathMarks + ", historyMarks=" + historyMarks
		+ ", hindiMarks=" + hindiMarks + ", percentage=" + percentage + ", division=" + division + "]";
    }
}
